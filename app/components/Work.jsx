...
const Work = ({isDarkMode}) => {
    return (
        ...
        transition={{duration: 1}}  id='work' className='w-full px-[12%] py-10 scroll-mt-20'>
            ...
            transition={{duration: 0.5, delay: 0.7}}  className='text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo'>Welcome to my Web development Portfolio!
            ...
            transition={{duration: 0.6, delay: 0.9}} className='grid grid-cols-auto my-10 gap-5 dark:text-black'>
                {workData.map((project, index) => (
                    <motion.div whileHover={{scale: 1.05}} transition={{duration: 0.3}} key={index} className='aspect-square bg-no-repeat bg-cover 
