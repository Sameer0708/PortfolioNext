            ...
            <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }}
                ...
                <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }}
                    ...
                    <div className='mb-10 max-w-2xl font-Ovo'>
                        Hello, I'm Sameer Purnachandra Sahu, a final-year IT Engineering student at
                        M.H. Saboo Siddik College of Engineering, with internship experience at Heuristic Tech
                        and Devlancers. I’m honing my skills in Full Stack Development and cutting-edge
                        web technologies.
                        <motion.ul initial={{ opacity: 0 }} whileInView={{ opacity: 1 }}
                            ...
                            {infoList.map(({ icon, iconDark, title, description },
                                ...
                                <motion.li whileHover={{ scale: 1.05 }} className='border-[0.5px] border-gray-400 rounded-xl p-6 cursor-pointer hover:bg-lightHover
                        ...
                        <motion.ul initial={{ opacity: 0 }} whileInView={{ opacity: 1 }}
                            ...
                            {toolsData.map((tool, index) => (
                                <motion.li whileHover={{ scale: 1.1 }} className='flex items-center justify-center w-12 sm:w-14 aspect-square border 
